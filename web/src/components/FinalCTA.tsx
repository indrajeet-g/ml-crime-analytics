    ...
    <Section className="border-t border-[#d4d4d4] bg-[#fafafa] py-32 md:py-48">
      <Container>
        <Reveal className="flex flex-col items-center text-center">
          <h2 className="max-w-4xl text-5xl font-semibold leading-[1.05] track-tighter md:text-6xl lg:text-7xl">
          ...
          <p className="mt-8 max-w-2xl text-lg leading-relaxed text-[#737373]">
            Start uncovering hidden networks, tracking financial trails, and building solid evidence chains today.
          </p>
          <div className="mt-12">
            <Link
              href="/login"
