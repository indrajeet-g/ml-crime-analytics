        ...
        <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-[7fr_5fr] lg:gap-12">
          <Reveal className="min-w-0">
            ...
            <p className="mt-6 max-w-xl text-base leading-relaxed text-[#737373] md:mt-7 md:text-lg">
              <span className="text-[#0a0a0a]">NEXUS</span> helps investigators find hidden links across FIRs, call records, and transactions. Every match is reviewed and confirmed by an investigator before it is used.
            </p>
